...
# 绘制菱形标记
diamond_size = max(sales, default=0) * 0.03
...
ax.tick_params(colors='white')
ax.set_ylim(0, max(sales, default=0) * 1.2 or 100)
ax.grid(True, linestyle='--', alpha=0.3, color='#2b3f63')
for spine in ax.spines.values():
    spine.set_color('#2b3f63')
...
ax.set_ylim(0, max_sales * 1.25 or 100)
...
ax.tick_params(colors='white')
max_sales_2025 = max(sales_2025, default=0)
ax.set_ylim(0, max_sales_2025 * 1.35 or 100)
ax.grid(True, axis='y', linestyle='--', alpha=0.3, color='#2b3f63')
for spine in ax.spines.values():
    spine.set_color('#2b3f63')
